...
- 一键开启临时的用户级代理会话，适合 VSCode、JetBrains IDE、PowerShell、Command Prompt 和 Windows Terminal。
...
`-- scripts
    ...
    `-- global-proxy
        `-- codex-global-proxy-session.cmd
```
